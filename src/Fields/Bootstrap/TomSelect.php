...
class TomSelect extends Field
{
    ...
    {
        return [
            '//cdn.jsdelivr.net/npm/tom-select@2.5.2/dist/css/tom-select.min.css',
            '//cdn.jsdelivr.net/npm/tom-select@2.5.2/dist/css/tom-select.bootstrap5.min.css',
        ];
    }
    ...
    {
        return [
            '//cdn.jsdelivr.net/npm/tom-select@2.5.2/dist/js/tom-select.complete.min.js',
        ];
    }
