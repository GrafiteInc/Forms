...
### Refactor
- improved mention listing for quill
...
### Perf
- optimize hot-path form rendering
...
### Fix
- issue where input can be removed
...
### Fix
- Issues with delete methods

## [v7.2.2] - 2025-10-17

### Fix
- missing ability to access select
...
### Feature
- new renderWhen method for forms
...
### Fix
- date issue with datepicker

## [v7.0.6] - 2025-01-21

### Fixed
- Issue with empty labels
- Broken tests
